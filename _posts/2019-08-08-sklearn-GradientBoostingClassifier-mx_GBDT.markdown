---
layout: post
title:  "机械学习GBDT迭代决策树算法GradientBoostingClassifier"
date:   2019-08-06 13:19:48 +0800
categories: sklearn

---
# from sklearn.ensemble import GradientBoostingClassifier'#
机器学习GBDT迭代决策树算法GradientBoostingClassifier。
通过ztop_ai极宽智能模块库mx_GBDT函数。
# 原代码 #
{% highlight ruby %}
import pandas as pd
...
def mx_GBDT(train_x,train_y):
    ...
    mx.fit(train_x,train_y)
    return mx
mx = mx_GBDT(x_train.values,y_train.values)
